...
PYTHON_2_PATH="/Users/zooxmusic/.pyenv/versions/2.7.18/bin/python"
export PATH="$PYTHON_2_PATH:$GSTREAMER_PATH:$GSTREAMER_HEADERS_PATH:$GSTREAMER_COMMANDS_PATH:/usr/local/sbin:$GST_PLUGIN_PATH:$PATH"
